        ...
        <header className="sticky top-0 z-30 border-b border-white/10 bg-[#020617]/80 backdrop-blur-md">
          <nav className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-3 md:px-8">
            ...
            <div className="flex flex-wrap items-center justify-end gap-2">
              ...
              <Link href="/forest-run" className="rounded-full border border-orange-400/40 bg-orange-400/10 px-3 py-1 text-xs font-semibold text-orange-200 transition hover:border-orange-300 hover:bg-orange-400/20">Forest Run</Link>
